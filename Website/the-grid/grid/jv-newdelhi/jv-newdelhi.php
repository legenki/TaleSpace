...
$output .= $tg_el->get_content_wrapper_start();
	...
	$output.= "<div class='jv-meta-wrap row'><div class='col-md-3'><i class='icon-icon-bed'></i><span class='jv-meta jv-meta-bed'>". $jv_el->get_jv_bedrooms_raw() ."</span></div>";
	$output.= "<div class='col-md-3'><i class='icon-icon-bath'></i><span class='jv-meta jv-meta-bath'>". $jv_el->get_jv_bathrooms_raw() ."</span></div>";
	$output.= "<div class='col-md-3'><i class='icon-icon-garage'></i><span class='jv-meta jv-meta-garage'>". $jv_el->get_jv_garages_raw() ."</span></div></div>"; 
