...
<div class="jv-my-page">
	...
	<div class="container secont-container-content">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-sm-9 main-content-right edit_my_profile dashboard-right" id="main-content">
				<div class="row">
					<div class="col-md-12">
										...
										<form method="post" enctype="multipart/form-data">
											...
											<div class="javo-form-div <?php echo empty($edit)?"hidden":"";?>">
												...
												<div class="row">
													...
													<div class="col-xs-12 col-md-9"><input type="text" class="form-control" name="jvfrm_home_r[user_login]" value="<?php jvfrm_home_input_str("user_login", (!empty($edit)? $edit->user_login : NULL));?>" data-required placeholder="<?php esc_attr_e('Username', 'javohome');?>" <?php echo (($edit)?"readonly" : "");?>></div>
												</div>
												...
												<div class="javo-register advanced">
													...
													<div class="row">
														...
														<div class="col-xs-12 col-lg-9"><input type="text" class="form-control" name="jvfrm_home_r[fax]" value="<?php jvfrm_home_input_str("fax", (!empty($edit)?get_user_meta($edit->ID, "fax", true):null));?>"></div>
													</div>
													<hr>
													<div class="row picture-upload-wrap">
														<div class="col-xs-12 col-md-3"><div class="well well-sm"><?php esc_html_e('Picture', 'javohome') ?></div></div>
														<div class="col-xs-12 col-md-9">
															<div class="row">
													...
													<div class="row">
														...
														<div class="col-xs-12 col-md-9"><?php wp_editor((($edit)? get_user_meta($edit->ID, "description", true) : ""), "javo-propfile-textarea", Array("textarea_name"=>"jvfrm_home_r[description]", "editor_class"=>"form-control", 'media_buttons' => 0));?></div>
													</div>
